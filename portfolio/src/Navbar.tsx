...
function Navbar() {
  return (
    <nav className="navbar" role="navigation">
      <a className="navbar__iconLink" href="#top" aria-label="Home">
      ...
      <div className="navbar__links">
        <a className="navbar__iconLink" href="#profession" aria-label="Profession">
          <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a className="navbar__iconLink" href="#projects" aria-label="Projects">
          <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a className="navbar__iconLink" href="#contact" aria-label="Contact">
          <svg viewBox="0 0 24 24" aria-hidden="true">
