...
const BLINKER_CELLS: ReadonlyArray<readonly [number, number]> = [
  [0, 0], [1, 0], [2, 0]
];
const TOAD_CELLS: ReadonlyArray<readonly [number, number]> = [
  [1, 0], [2, 0], [3, 0], [0, 1], [1, 1], [2, 1]
];
const BEACON_CELLS: ReadonlyArray<readonly [number, number]> = [
  [0, 0], [1, 0], [0, 1], [1, 1],
  [2, 2], [3, 2], [2, 3], [3, 3]
];
const PULSAR_CELLS: ReadonlyArray<readonly [number, number]> = [
